...
class App:
    def __init__(self):
        ...
        self.tools = ["brush", "line", "arrow", "text", "copy", "square", "back"]
        self.colors = [
            (0, 0, 0),       # black
            (255, 255, 255), # white
            (128, 128, 128), # gray
    ...
    def draw_toolbar(self, last):
        ...
        for tool in self.tools:
            self.toolbar.blit(pygame.transform.scale(pygame.image.load(tool+".png"), (40, 40)), (x+5, 5))
            x+=50
    ...
    def draw_colorbar(self):
        ...
        for color in self.colors:
            ...
            x+=34.375
        pygame.draw.rect(self.colorbar, (50, 50, 50), (0, self.curr_color*34.375, 35, 34.375), 5)
        mouse = pygame.mouse.get_pos()
        if mouse[1] > 50 and mouse[1] < 600 and pygame.mouse.get_pressed()[0] and mouse[0] < 35:
            self.clicked = False
    ...
    def draw_curr_tool(self, last):
        ...
        if mouse[1] > 50 and mouse[1] < 600 and mouse[0] > 35:
            ...
            if self.curr_op == 0:
                pygame.draw.circle(self.canvas, self.colors[self.curr_color], (x, y), self.size)
                if pygame.mouse.get_pressed()[0]:
                    self.objs.append([self.curr_op, self.colors[self.curr_color], self.size, (x, y)])
            elif self.curr_op == 1:
                if pygame.mouse.get_pressed()[0] and not last:
                    ...
                    if self.clicked:
                        ...
                        self.objs.append([self.curr_op, self.colors[self.curr_color], self.size, tuple(self.last_pos), (x, y)])
                if self.clicked:
                    pygame.draw.line(self.canvas, self.colors[self.curr_color], self.last_pos, (x, y), self.size)

            elif self.curr_op == 2:
                if pygame.mouse.get_pressed()[0] and not last:
                    self.objs.append([self.curr_op, self.colors[self.curr_color], self.size, (x, y), self.angle])
                arrow = pygame.transform.scale(self.arrow, (self.size*2, self.size*2))
                rect = arrow.get_rect()
                rect.center = (x, y)
                ...
                if pygame.mouse.get_pressed()[0] and not last and self.temp_text != "":
                    self.objs.append([self.curr_op, self.colors[self.curr_color], self.size, (x, y), self.temp_text, self.angle])
                ...
                if pygame.mouse.get_pressed()[0] and not last:
                    ...
                    if self.clicked:
                        ...
                        img = Image.frombytes("RGBA", (self.canvas.get_width(), self.canvas.get_height()), pygame.image.tostring(self.canvas, "RGBA"))
                ...
                if self.clicked:
                    pygame.draw.rect(self.canvas, (0,0,0), (self.last_pos[0], self.last_pos[1], x-self.last_pos[0], y-self.last_pos[1]), 1)
                ...
                if pygame.mouse.get_pressed()[0] and not last:
                    ...
                    if self.clicked:
                        ...
                        self.objs.append([self.curr_op, self.colors[self.curr_color], self.size, (self.last_pos[0], self.last_pos[1]), (x, y)])
                if self.clicked:
                    pygame.draw.rect(self.canvas, (0,0,0), (self.last_pos[0], self.last_pos[1], x-self.last_pos[0], y-self.last_pos[1]), self.size)
    ...
    def draw_objs(self):
        for obj in self.objs:
            if obj[0] == 0:
                ...
                pygame.draw.rect(self.canvas, obj[1], (obj[3][0], obj[3][1], obj[4][0]-obj[3][0], obj[4][1]-obj[3][1]), obj[2])
